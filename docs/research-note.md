...
A few destinations for the same engine: a city leader's development mirror; a strengths-spotter that names a capacity the leader hasn't claimed; a meeting/Zoom coherence analyser that flags where a team *says one thing and decides another*; a longitudinal personal companion for adult development.
